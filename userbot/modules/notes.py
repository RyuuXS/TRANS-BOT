...
@bot.on(cilik_cmd(outgoing=True, pattern=r"notes$"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"rmbotnotes (.*)"))
