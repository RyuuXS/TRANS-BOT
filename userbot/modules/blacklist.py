...
@bot.on(cilik_cmd(incoming=True))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
