...
@bot.on(trans_cmd(incoming=True))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
