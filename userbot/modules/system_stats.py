...
@trans_cmd(pattern="(?:alive|on)\s?(.)?")
async def amireallyalive(alive):
    user = await bot.get_me()
    uptime = await get_readable_time((time.time() - StartTime))
    output = (
        f"**[TRANS-BOT](https://github.com/RyuuXS/TRANS-BOT) is Up and Running.**\n\n"
