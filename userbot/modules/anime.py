...
@bot.on(cilik_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(cilik_cmd(outgoing=True, pattern="whatanime$"))
