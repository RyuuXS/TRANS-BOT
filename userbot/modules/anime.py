...
@bot.on(trans_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(trans_cmd(outgoing=True, pattern="whatanime$"))
