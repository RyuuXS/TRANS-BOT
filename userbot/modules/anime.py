...
@trans_cmd(pattern="a(kaizoku|kayo) ?(.*)")
    ...
    if not ig and isinstance(media, MessageMediaDocument):
        ...
        for i in attribs:
            if isinstance(i, DocumentAttributeFilename):
                ...
                break
    xx = await edit_delete(e, "`Downloading image..`")
