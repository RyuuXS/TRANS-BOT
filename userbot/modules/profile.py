...
@bot.on(trans_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(trans_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
