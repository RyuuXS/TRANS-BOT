...
@bot.on(trans_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"rmwelcome$"))
