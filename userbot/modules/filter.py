...
@bot.on(trans_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"filters$"))
