...
@bot.on(trans_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(trans_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(trans_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
