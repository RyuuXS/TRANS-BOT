    ...
    try:
        ...
        if event.reply_to_msg_id:
            ...
            if previous_message.from_id is None:
                if not noedits:
                    await edit_delete(
                        transevent, "**ERROR: Dia adalah anonymous admin!**", 60
                    )
                return None, None
...
async def checking():
    trans = str(pybase64.b64decode("QEJlbGFqYXJiZXJzYW1hcnl1dQo="))[2:13]
    xtrans = str(pybase64.b64decode("QGhlbHBmb3JSWVVVCg=="))[2:17]
    userbot = str(pybase64.b64decode("QEF4ZVN0b3JlRAo="))[2:13]
    xuserbot = str(pybase64.b64decode("QFRJTkdHQUxKQURJCg=="))[2:17]
    try:
